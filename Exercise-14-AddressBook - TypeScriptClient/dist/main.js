...
class AddressServer {
    static createContact(pid, name, age, hno, street, city) {
        axios_1.default({
            method: 'get',
    ...
    static getContacts() {
        const API_URL = 'http://localhost:3000/getAll';
...
function addContactInfo() {
    ...
    addressserver_1.default.createContact(Number(pid.value), name.value, Number(age.value), hno.value, street.value, city.value);
}
exports.default = addContactInfo;
function getContacts() {
    addressserver_1.default.getContacts()
        .then((response) => {
